...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        hero1: "url('/assets/hero-banner-final.webp')",
        serviceBg: "url('/assets/serviceLinear.png')",
        futurepers: "url('/assets/future-perspec-mobile.webp')",
        singleServiceBg: "url('/assets/g10.png')",
        missionBg: "url('/assets/missionBack_lossyalpha.webp')",
        choseUsBg: "url('/assets/chooseUseBg.png')",
        visdionBg: "url('/assets/vision.webp')",
        aboutUsBg: "url('/assets/About Us 1(1).png')",
        testBg: "url('/assets/arrow circle.png')",
        secondSlidebg: "url('/assets/secondBgSlide2_lossyalpha.webp')",
